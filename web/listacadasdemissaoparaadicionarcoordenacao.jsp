...
<html>
    <head>
        ...
        <link href="Estilolistacasasdemissaoparaadicionarcoordenacao.css" rel="stylesheet" type="text/css"><!--EstiloCadastroDeIrmas.css-->
    </head>
...
<!--                                <a href="/ImCarm/#">
                    ...
                    <div id="funcionalidade">
                        <div id="conteudo_funcionalidade">
                            <h3 align="center">Selecionar Fraternidade para Adicionar Coordenação</h3>
...
<!--                                    <div id="linha_conteudo_alterar">
                                    ...
                                    <div id="linha_conteudo_apagar">
                                        <form action="/ImCarm_2.0/ServletControler" method="post">
                                            ...
                                            <input type="hidden" name="id_fraternidade" value="${fraternidade.idFraternidade}">
                                            <input type="hidden" name="next_url" value="formcadastracoordenacaodecasademissao.jsp">
                                            <button class="i2Style_apagar">Adicionar Coordenacao</button>
                                        </form>
                                    </div>
                                </div>
                            </c:forEach>
