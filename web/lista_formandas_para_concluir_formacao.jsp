                ...
                <div id="conteudo_centro">
                    ...
                    <div id="funcionalidade">
                        <div id="conteudo_funcionalidade">
                            <h3 align="center"> Escolher Formanda para Concluir Formação</h3>
...
<!--                                    <div id="linha_conteudo_alterar">
                                    ...
                                    <div id="linha_conteudo_apagar">
                                        <form action="/ImCarm_2.0/ServletControler" method="post">
                                            <input type="hidden" name="action" value="69">
                                            <input type="hidden" name="id_formanda_concluir" value="${formanda.idFormanda}">
                                            <b style="font: bold Tahoma">Data de Conclusão: </b>
                                            <input type="date" name="data_conclusao_formacao">
                                            <input type="submit" class="i2Style_apagar"value="Concluir Formação">
                                        </form>
                                    </div>
                                </div>
                            </c:forEach>
