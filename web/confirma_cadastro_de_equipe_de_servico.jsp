...
<html>
    <head>
        ...
        <link href="estilo_confirma_cadastro_de_equipe_de_servico.css" rel="stylesheet" type="text/css"><!--EstiloCadastroDeIrmas.css-->
    </head>
                            ...
                            <div id="linha_buttons">
                                <div id="option_buttons_1">
                                    <form action="/ImCarm_2.0/ServletControler" method="post">
                                        <input type="hidden" name="action" value="45">
                                        <input type="hidden" name="id_equipe_servico" value="${equipe_servico.idEquipe}">
