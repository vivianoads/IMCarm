		...
		<div id="container"> 
			...
			<div id="menu">
				...
				<div id="login">
					...
					<form name="alteradadosirma" action="/ImCarm/AlteraIrma" method="post">
					
					<table cellspacing="25" width="500">
						<tr>
							<td colspan="2" > <b>Escolha a forma de busca e informe a Irmã que deseja apagar</b> </td>
						...
						<tr>
							...
							<td><input type="text" name="dados"><input type=hidden name="acao" value="apagar"></td>
						</tr>
						...
						<tr>
							...
							<td align="center" colspan="2"> <a href="/cadastrodeirmas.jsp">Retornar ao Menu Inicial.</a> </td>
						</tr>
