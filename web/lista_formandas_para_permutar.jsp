...
<!--                                <a href="/ImCarm/#">
                    ...
                    <div id="funcionalidade">
                        <div id="conteudo_funcionalidade">
                            <h3 align="center"> Escolher Formanda para Permutar a Formação</h3>
...
<!--                                    <div id="linha_conteudo_alterar">
                                    ...
                                    <div id="linha_conteudo_apagar">
                                        <form action="/ImCarm_2.0/ServletControler" method="post">
                                            ...
                                            <input type="hidden" name="id_formanda_permuta" value="${formanda.idFormanda}">
                                            <input type="submit" class="i2Style_apagar"value="Permutar">
                                        </form>
                                    </div>
                                </div>
                            </c:forEach>
