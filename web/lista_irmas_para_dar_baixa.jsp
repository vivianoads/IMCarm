...
<!--                                <a href="/ImCarm/#">
                    ...
                    <div id="funcionalidade">
                        <div id="conteudo_funcionalidade">
                            <h3 align="center"> Selecionar Freira para dar Baixa</h3>
...
<!--                                    <div id="linha_conteudo_alterar">
                                    ...
                                    <div id="linha_conteudo_apagar">
                                        <form action="/ImCarm_2.0/ServletControler" method="post">
                                            <input type="hidden" name="action" value="77">
                                            <input type="hidden" name="id_freira_baixa" value="${freira.id}">
                                            <b style="font: bold 14px Tahoma">Motivo: </b>
                                            <input style="width: 200px" type="text" name="motivo_baixa">
                                            <input type="submit" class="i2Style_apagar"value="Dar Baixa">
                                        </form>
                                    </div>
                                </div>
                            </c:forEach>
