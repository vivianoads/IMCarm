...
<html>
    <head>
        ...
        <link href="estilo_confirma_edicao_de_coordenacao_de_casas_de_missao.css" rel="stylesheet" type="text/css"><!--EstiloCadastroDeIrmas.css-->
    </head>
                            ...
                            <div id="linha_buttons">
                                <div id="option_buttons_1">
                                    <form action="/ImCarm_2.0/ServletControler" method="post">
                                        ...
                                        <input type="submit" class="i2Style_apagar" value="Cancelar Edição">
                                    </form>
                                </div>
<!--                                <div id="option_buttons_2">
                                ...
                                <div id="option_buttons_3">
                                    <form action="/ImCarm_2.0/ServletControler" method="post">
                                        ...
                                        <input type="submit" class="i2Style" value="Edit Coordenação">
                                    </form>
                                </div>
                            </div>
                        </div>
