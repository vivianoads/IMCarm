...
<html>
    <head>
        ...
        <link href="estilo_lista_irmas_para_escolher_coordenadora.css" rel="stylesheet" type="text/css"><!--EstiloCadastroDeIrmas.css-->
    </head>
                ...
                <div id="conteudo_centro">
                    ...
                    <div id="funcionalidade">
                        <div id="conteudo_funcionalidade">
                            <h3 align="center"> Escolher Coordenadora para a Fraternidade **${fraternidade.nome}**</h3>
...
<!--                                    <div id="linha_conteudo_alterar">
                                    ...
                                    <div id="linha_conteudo_apagar">
                                        <form action="/ImCarm_2.0/ServletControler" method="post">
                                            ...
                                            <input type="hidden" name="id_fraternidade" value="${fraternidade.idFraternidade}">
                                            <input type="hidden" name="id_coordenadora" value="${freira.id}">
