 ...
 * @author viviano
 */
public class BuscaFormandaPorNome implements Command{
    ...
    public String execute(HttpServletRequest request) {
        ...
        try {
            formandas = formandaDao.getAllFormandaBeanPorNome(nome);
...
//            
            ...
            Logger.getLogger(BuscaFormandaPorNome.class.getName()).log(Level.SEVERE, null, ex);
