 ...
 * @author viviano
 */
public class BuscaFreiraPorIdadeReligiosaperpetua implements Command{

    @Override
    public String execute(HttpServletRequest request) {
        String nextPage = "lista_irma_consulta.jsp";
        Integer idade = new Integer(request.getParameter("idade_religiosa_perpetua"));
        ...
        try {
            ...
            Logger.getLogger(BuscaFreiraPorIdadeReligiosaperpetua.class.getName()).log(Level.SEVERE, null, ex);
