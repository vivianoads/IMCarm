 ...
 * @author viviano
 */
public class BuscaFreiraPorNomeReligioso implements Command{
    ...
    public String execute(HttpServletRequest request) {
        ...
        try {
            freiras = freiraDao.getAllFreiraBeanComStringNoNomeReligioso(nome);
...
//            
            ...
            Logger.getLogger(BuscaFreiraPorNomeReligioso.class.getName()).log(Level.SEVERE, null, ex);
