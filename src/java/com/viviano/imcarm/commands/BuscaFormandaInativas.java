 ...
 * @author viviano
 */
public class BuscaFormandaInativas implements Command{
...
//        String nome = request.getParameter("formanda_por_etapa");
        ...
        try {
            formandas = formandaDao.getAllFormandaBeanDadoBaixa();
...
//            
            ...
            Logger.getLogger(BuscaFormandaInativas.class.getName()).log(Level.SEVERE, null, ex);
