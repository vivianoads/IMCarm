 ...
 * @author viviano
 */
public class CancelaCadastroFormandaCommand implements Command{
    ...
    public String execute(HttpServletRequest request) {
        ...
        try {
            formandaDao.apagaFormandaBean(idFormanda);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(CancelaCadastroFormandaCommand.class.getName()).log(Level.SEVERE, null, ex);
