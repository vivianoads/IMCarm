...
import com.viviano.imcarm.commands.BuscaFreiraPorBodasDeVotosPerpetuos;
import com.viviano.imcarm.commands.BuscaFreiraPorBodasDeVotosSimples;
import com.viviano.imcarm.commands.BuscaFreiraPorEquipe;
import com.viviano.imcarm.commands.BuscaFreiraPorFraternidade;
import com.viviano.imcarm.commands.BuscaFreiraPorIdadeCivil;
import com.viviano.imcarm.commands.BuscaFreiraPorIdadeReligiosaSimples;
import com.viviano.imcarm.commands.BuscaFreiraPorIdadeReligiosaperpetua;
import com.viviano.imcarm.commands.BuscaFreiraPorNomeCivil;
import com.viviano.imcarm.commands.BuscaFreiraPorNomeReligioso;
...
public class Helper {
	...
	private Helper(){
		...
		mapCommands.put("11", new LogoutCommand());
                ...
                mapCommands.put("86", new BuscaFreiraPorIdadeReligiosaperpetua());
                mapCommands.put("87", new BuscaFreiraPorBodasDeVotosSimples());
                mapCommands.put("88", new BuscaFreiraPorBodasDeVotosPerpetuos());
                mapCommands.put("89", new BuscaFreiraPorIdadeCivil());
                mapCommands.put("90", new BuscaFreiraPorNomeCivil());
                mapCommands.put("91", new BuscaFreiraPorNomeReligioso());
                mapCommands.put("92", new BuscaFreiraAtivas());
                mapCommands.put("93", new BuscaFreiraAtivasEmEstadoRegular());
                mapCommands.put("94", new BuscaFreiraAtivasEmLicenca());
                mapCommands.put("95", new BuscaFreiraAtivasEnclaustradas());
                mapCommands.put("96", new BuscaFreiraInativas());
                mapCommands.put("97", new BuscaFreiraInativasPorSaida());
                mapCommands.put("98", new BuscaFreiraInativasPorObito());
                mapCommands.put("99", new BuscaFormandaPorFase());
                mapCommands.put("100", new BuscaFormandaPorNome());
                mapCommands.put("101", new BuscaFormandaAtivas());
                mapCommands.put("102", new BuscaFormandaInativas());
                mapCommands.put("103", new BuscaFormandasTodas());
                mapCommands.put("104", new BuscaFreiraPorEquipe());
                mapCommands.put("105", new BuscaFormandaPorEquipe());
                mapCommands.put("106", new BuscaEquipeDeDervicoDoGovernoAtual());
                mapCommands.put("107", new BuscaFreiraPorFraternidade());
