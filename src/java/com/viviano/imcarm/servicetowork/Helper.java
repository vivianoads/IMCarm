...
import com.viviano.imcarm.commands.CancelaReativacaoFreiraCommand;
import com.viviano.imcarm.commands.CancelarBaixaEmFreira;
...
import com.viviano.imcarm.commands.ConfirmaBaixaEmFreira;
...
import com.viviano.imcarm.commands.DarBaixaEmFreiraCommand;
...
import com.viviano.imcarm.commands.ListaIrmasParaDarBaixa;
import com.viviano.imcarm.commands.ListaIrmasParaEditar;
import com.viviano.imcarm.commands.ListaIrmasParaGerarCoordenacao;
import com.viviano.imcarm.commands.ListaIrmasParaReativar;
...
import com.viviano.imcarm.commands.ReativarFreiraCommand;
...
import com.viviano.imcarm.commands.SelecionarIrmaParaEditar;
...
public class Helper {
	...
	private Helper(){
		...
		mapCommands.put("11", new LogoutCommand());
                ...
                mapCommands.put("74", new ListaIrmasParaEditar());
                mapCommands.put("75", new SelecionarIrmaParaEditar());
                mapCommands.put("76", new ListaIrmasParaDarBaixa());
                mapCommands.put("77", new DarBaixaEmFreiraCommand());
                mapCommands.put("78", new ConfirmaBaixaEmFreira());
                mapCommands.put("79", new CancelarBaixaEmFreira());
